...
public class KwernScreen extends AbstractContainerScreen<KwernMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Patina.MODID, "textures/gui/kwern.png");
    public KwernScreen(KwernMenu menu, Inventory playerInventory, Component title) {
