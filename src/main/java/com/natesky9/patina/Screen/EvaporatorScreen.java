...
public class EvaporatorScreen extends AbstractContainerScreen<EvaporatorMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Patina.MODID, "textures/gui/evaporator.png");
    public EvaporatorScreen(EvaporatorMenu menu, Inventory playerInventory, Component title) {
